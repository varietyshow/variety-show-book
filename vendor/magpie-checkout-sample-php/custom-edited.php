...
<head>
  ...
  <!-- We use jQuery for this example. -->
  <script src="https://code.jquery.com/jquery-2.2.4.min.js" crossorigin="anonymous"></script>
  <!-- We load checkout.js from here. -->
...
<section class="mbr-section mbr-section-hero mbr-section-full header1 header2 mbr-after-navbar" id="header2-h" data-rv-view="49" style="background: linear-gradient(to right top, rgb(99, 28, 112), rgb(60, 168, 199)) rgb(99, 28, 112);">
        ...
        <div class="container">
            <div class="row heading">
                <div class="col-md-10">
                    ...
                    <h1 class="mbr-section-title display-1 heading-title"><br>Custom integration</h1>
                    <p class="mbr-section-subtitle sub-2 heading-text"><br>Sometimes, you want a user experience that is your own, defined by your brand. While creating a PayButton via Magpie's Checkout v2 product via simple integration is fast and easy, it can only go so far. If you want to create custom look and feel, you will want to use the power of JavaScript and your backend smarts to make Checkout your own.<br></p>
                    <div class="mbr-section-btn"><a class="btn btn-lg btn-primary" href="#" id="not_all">NOT ALL PAYBUTTONS ARE BLUE</a><a class="btn btn-lg btn-empty" href="#" id="not_button">AND SOME PAY LINKS ARE NOT EVEN A BUTTON</a></div>
                </div>
            </div>
        </div>
...
<section class="mbr-section pricingtable2" id="pricing-table2-j" data-rv-view="55" style="background-color: rgb(255, 252, 246); padding-top: 40px; padding-bottom: 40px;">
      ...
      <div class="container heading">
          <div class="row">
              <div class="col-xs-12 text-xs-center">
                  <h3 class="heading-title mbr-section-title display-3">Make the PayButton your own</h3>
    ...
    <div class="container">
      <div class="row plan">
        <div class="plan-wrap col-xs-12 default col-lg-3" style="display: block;">
          ...
          <div class="plan-btn text-xs-center"><a href="#" class="btn btn-lg btn-primary-outline" id="start_pkg">Buy now!</a></div>
        </div>
        ...
        <div class="plan-wrap col-xs-12 favorite col-lg-3" style="display: block;">
          ...
          <div class="plan-btn text-xs-center"><a href="#" class="btn btn-lg btn-black-outline" id="business_pkg">Buy now!</a></div>
        </div>
        ...
        <div class="plan-wrap col-xs-12 default col-lg-3" style="display: block;">
          ...
          <p class="plan-text mbr-section-text text-1">25 GB bandwidth</p>
          
          
          
          
          <div class="plan-btn text-xs-center"><a href="#" class="btn btn-lg btn-warning-outline" id="premium_pkg">Buy now!</a></div>
        </div>
        ...
        <div class="plan-wrap col-xs-12 default col-lg-3" style="display: block;">
          ...
          <p class="plan-text mbr-section-text text-1">35 GB bandwidth</p>
          
          
          
          
          <div class="plan-btn text-xs-center"><a href="#" class="btn btn-lg btn-danger-outline" id="ultimate">Buy now!</a></div>
        </div>
      </div>
    </div>   
</section>

<section class="mbr-section mbr-section-hero features5" id="features5-n" data-rv-view="65" style="background-image: url(assets/images/02.jpg); padding-top: 40px; padding-bottom: 40px;">
      ...
      <div class="container">
          <div class="row heading">
              <div class="col-xs-12">
                  ...
                  <h1 class="mbr-section-title display-3 heading-title">Always on your terms</h1>
                  <p class="mbr-section-text text-1 heading-text">Use font icons to quickly load graphical meanings. With custom integration, you can use image or icon links to trigger Checkout.<br>Checkout the following examples, with varied configurations, to see what is possible.</p>
      ...
      <div class="container">
              <div class="row">
                  ...
                  <div class="mbr-cards-col col-xs-12 col-lg-4">
                      ...
                      <div class="card">
                          <div class="card-box col-xs-9 mbr-table-cell text-xs-left">
                              <h4 class="card-title mbr-section-subtitle sub-2">Buying a gift and having it delivered.</h4>
                          </div>
                          <div class="card-img col-xs-3 mbr-table-cell"><a href="#" class="mbri-gift mbr-iconfont" style="font-size: 48px;" id="ex_shipping"></a></div>
                          <div class="clear"></div>
                      </div>
                  </div>
                  ...
                  <div class="mbr-cards-col col-xs-12 col-lg-4">
                      ...
                      <div class="card">
                          <div class="card-box col-xs-9 mbr-table-cell text-xs-left">
                              <h4 class="card-title mbr-section-subtitle sub-2">Paying rent, collect billing information.</h4>
                          </div>
                          <div class="card-img col-xs-3 mbr-table-cell"><a href="#" class="mbri-home mbr-iconfont" style="font-size: 48px;" id="ex_billing"></a></div>
                          <div class="clear"></div>
                      </div>
                  </div>
                  ...
                  <div class="mbr-cards-col col-xs-12 col-lg-4">
                      ...
                      <div class="card">
                          <div class="card-box col-xs-9 mbr-table-cell text-xs-left">
                              <h4 class="card-title mbr-section-subtitle sub-2">Donations, simple checkout form.</h4>
                          </div>
                          <div class="card-img col-xs-3 mbr-table-cell"><a href="#" class="mbri-like mbr-iconfont" style="font-size: 48px;" id="ex_donate"></a></div>
                          <div class="clear"></div>
                      </div>
                  </div>
...
<section class="mbr-section accordion toggle1" id="toggle1-f" data-rv-view="43" style="background-color: rgb(255, 255, 255); padding-top: 100px; padding-bottom: 100px;">
                  ...
                  <div class="accordion-group">
                    <div class="toggle-panel panel-default colorBG" style="display: block;">
                        <div class="toggle-heading" role="tab" id="headingOne">
                            ...
                            <h4 class="panel-title display-6"><a role="button" class="collapsed" data-toggle="collapse" data-parent="#accordion" data-core="" href="#collapseOnetoggle1-f" aria-expanded="false" aria-controls="collapseOne"><span class="sign"></span>Button using an image</a></h4>
                        </div>
                        <div id="collapseOnetoggle1-f" class="panel-collapse noScroll collapse in" role="tabpanel" aria-labelledby="headingOne">
                            <div class="panel-body"><p>Images are a great way to create custom buttons. Using CSS, you can also create buttons with font icons, and dictate colors, as needed.</p>
                                <!--Shipping button-->
                                <!-- Custom-->
                                <table>
                                  <tr>
                                    <td>
                                      <a href="#" id="red_button"><img src="https://s3-us-west-2.amazonaws.com/client-objects/sample-app/pay-button-red.png" style="width:75%;height:75%;"></a>
                                    </td>
                                    <td style="padding:5px;"></td>
                                    <td>
                                        <a href="#" class="btn btn-lg btn-danger-outline" id="shop_cart"><span class="mbri-shopping-cart mbr-iconfont mbr-iconfont-btn"></span>Buy now!</a>
                                    </td>
                                  </tr>
                                </table>
                              <br>
                    ...
                    <div class="toggle-panel panel-default" style="display: block;">
                        <div class="toggle-heading" role="tab" id="headingTwo">
                            ...
                            <h4 class="panel-title display-6"><a role="button" class="" data-toggle="collapse" data-parent="#accordion" data-core="" href="#collapseTwotoggle1-f" aria-expanded="true" aria-controls="collapseTwo">Letting forms set Checkout details</a></h4>
                        </div>
                        <div id="collapseTwotoggle1-f" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingTwo">
                            <div class="panel-body"><p>Let's say you want to collect donation from people, and you want them to set how much and in what currency they want to donate. You can collect data and trigger Checkout using custom integration.<br><br>The following form creates a Checkout form based on form inputs. (Implement your own CSS to make it pretty :) Also, try out the various currencies to see how dynamic and flexible Checkout can be!</p>
                              ...
                              <table>
                                <tr>
                                  <td>
                                      My email is <input type="email" name="email" required pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}" placeholder="Email">.
                                  </td>
                                </tr>
                                <tr><td style="padding:5px;"></td></tr>
                                <tr>
                                  <td>
                                    I want to donate <input type="number" required name="amount" width="10" min="1" placeholder="1.00" step="0.01">
                                  </td>
                                  <td>
                                    ...
                                    <tr>
                                      <td>
                                        ...
                                        <select name="recipient">
                                          ...
                                          <option value="Sport Facility">Sports Facilities</option>
                    ...
                    <div class="toggle-panel panel-default" style="display: block;">
                        ...
                        <div id="collapseThreetoggle1-f" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingThree">
                            <div class="panel-body">
                              <!-- Email form-->
                              <form id="target">
                                  <input type="email" required pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}" placeholder="Your email">
...
<footer class="mbr-small-footer mbr-section mbr-section-nopadding footer4" id="footer4-k" data-rv-view="58" style="background-color: rgb(255, 227, 171); padding-top: 1.75rem; padding-bottom: 1.75rem;">
  ...
  <!-- Load your client JS here. -->
  <script src="magpie-client.js"></script>
