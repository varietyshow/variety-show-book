...
<section class="mbr-section mbr-section-hero mbr-section-full header4 mbr-section-with-arrow mbr-after-navbar" id="header4-y" data-rv-view="28" style="background-image: url(assets/images/04.jpg);">
        ...
        <div class="container">
            <div class="row heading">
                <div class="col-md-10 col-md-offset-1 text-xs-center">
                    ...
                    <h1 class="mbr-section-title display-1 heading-title">Integration Samples</h1>
                    <p class="mbr-section-subtitle sub-2 heading-text">We go end to end here. Click on the White Arrow to see the examples.<br><strong><a href="index.html">Go back to Home</a></strong></p>
    ...
    <div class="mbr-arrow mbr-arrow-floating" aria-hidden="true"><a href="#header3-w"><i class="mbri-down"></i></a></div>

</section>

<section class="mbr-section mbr-section-hero header3" id="header3-w" data-rv-view="21" style="background-image: url(assets/images/header3.jpg); padding-top: 50px; padding-bottom: 50px;">
                ...
                <div class="mbr-section row" style="padding-top: 50px; padding-bottom: 50px;">
                    <div class="mbr-table-md-up">
                        ...
                        <div class="mbr-table-cell mbr-right-padding-md-up col-md-5 text-xs-center text-md-right">
                            ...
                            <h3 class="mbr-section-title display-2">Simple integration</h3>

                            <div class="mbr-section-text">
                                <p>First, you create a PayButton with copy-and-paste HTML code.<br>
                                    
                                    <form><input type="button" value="View Code" class="button1 modal1"></form>
                                    
                                    <br>Checkout then collects your customer's payment information and returns a token that you can use to charge your customer. The token and other information are automatically posted by Checkout to a server-side script that lets you send the charges to Magpie, for processing.</p>
                            </div>

                            <div class="mbr-section-btn">
                                <form method="POST" action="/simple_process.php">
                                <script src="https://checkout.magpie.im/v2/checkout.js"
                                  class="magpie-button"
                                  data-name="My Online Restaurant"
                                  ...
                                  data-description="Delicious Asian Fusion Food"
                                  data-billing="true"
                                  data-pay-label="Pay"
                                  data-button-label="Order This!">
                                </script>
                              </form>
                            </div>

                        </div>
                        <div class="mbr-table-cell mbr-valign-top col-md-7 image-size" style="width: 39%;">
...
<section class="mbr-section msg-box1" id="msg-box1-10" data-rv-view="57" style="background-color: rgb(255, 255, 255); padding-top: 50px; padding-bottom: 50px;">

    
    <div class="container">
        <div class="row">
          <h1 class="mbr-section-title display-2 text-center">Custom integration</h1> 
        </div>
        <div class="row">
            <div class="mbr-table-md-up">
              ...
              <div class="mbr-table-cell col-md-6 text-xs-center text-md-left">
                  ...
                  <div class="list">
                    <ul class="text-left"><li>Custom integration is not much different from simple integration. Checkout will still trigger the payment-collection form, return a token for charging, and you will still need to pass the data generated by the form to a server-side script of your own doing.<br><br></li><li>However, you can control the user experience in greater detail using your knowledge of JavaScript. The details of that will be up to you (or your developers and designers). Suffice it to say we allow you to create your own customer experience with your own branding.<br></li></ul>
                  </div>

                  <div class="left-button text-lg-left text-sm-center"><a class="btn btn-lg btn-danger" href="#"><span class="mbri-credit-card mbr-iconfont mbr-iconfont-btn"></span>Buy Now</a></div>
              </div>
