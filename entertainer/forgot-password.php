...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['contact_number'])) {
        ...
        $stmt = $conn->prepare("SELECT entertainer_id FROM entertainer_account WHERE contact_number = ?");
    ...
    if (isset($_POST['proceed_reset'])) {
        ...
        $updateStmt = $conn->prepare("UPDATE entertainer_account SET reset_token = ?, reset_expiry = ? WHERE contact_number = ?");
...
<body>
    <div class="container">
        ...
        <div class="back-link">
            <a href="entertainer-loginpage.php">
