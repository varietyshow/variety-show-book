...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['contact_number'])) {
        ...
        $stmt = $conn->prepare("SELECT admin_id FROM admin_account WHERE contact_number = ?");
    ...
    if (isset($_POST['proceed_reset'])) {
        ...
        $updateStmt = $conn->prepare("UPDATE admin_account SET reset_token = ?, reset_expiry = ? WHERE contact_number = ?");
